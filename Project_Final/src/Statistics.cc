...
{
	cout<<"Stats:\tAdding Attribute"<<endl;
...
{
	cout<<"Stats:\tCopying Relation"<<endl;
...
{
	cout<<"Stats:\tRead Operation"<<endl;
	ifstream reader;
...
{
	cout<<"Stats:\tWrite Operation"<<endl;
	ofstream writer;
...
double Statistics::Estimate(struct AndList *parseTree, char **relNames, int numToJoin)
{
	...
	cout << "Stats:\t Estimate , Size = " << AttrRelMap.size() <<endl;
	double estimate =0;
	bool no_error =true;
	joinset.clear();
